...
/*   Updated: 2024/09/13 13:35:45 by dyarkovs         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    stats(const ClapTrap& obj)
{
    std::cout << "\nName: " << obj._name << "|    ";
    std::cout << "Health:   " << obj._health << "|    ";
    std::cout << "Energy:   " << obj._energy << "|    ";
    std::cout << "Attack:   " << obj._attack << "|    " << std::endl << std::endl;
}
